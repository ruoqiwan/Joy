...
<div id="calculate_advance_stones"></div>
...
function calculate_advance_stones() {
  ...
  var advance_stones = (15600 - points_advance_stones)/1;
  document.getElementById("result_advance_crystals").textContent = "还需要消耗" + advance_stones + 个;
}
